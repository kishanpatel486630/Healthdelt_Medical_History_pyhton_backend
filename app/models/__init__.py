...
class MedicalHistory(Base):
    ...
    visitDate = Column(DateTime(timezone=True), nullable=False)
...
class Report(Base):
    ...
    reportDate = Column(DateTime(timezone=True), nullable=True)
...
class Prescription(Base):
    ...
    issuedDate = Column(DateTime(timezone=True), default=utc_now)
